...
Há ainda o jogo \textit{Jelly in the Sky}, recentemente disponibilizado para aquisição na plataforma de jogos para computador \textit{Steam}, que utiliza uma estrutura baseada em \textit{shader} similar à arquitetura apresentada aqui.
