...
Desenvolveu-se uma réplica em realidade virtual do jogo \textit{Snake} no ambiente de desenvolvimento \textit{Unity} com o efetivo uso das camadas de aplicação, geometria e rasterização. Neste jogo, posiciona-se o objeto coletável ao passo que a serpente busca-o a todo instante.  A imagem abaixo ilustra a taxa de quadros no \textit{GearVR} através da ferramenta de avaliação de performance da Unity, o \textit{profiler}:
