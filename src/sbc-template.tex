...
Em trabalhos futuros, três passos são percebidos como cruciais. Em primeiro lugar, migrar inteiramente os processos da camada lógica para serem executados na unidade gráfica de processamento, com o propósito de permitir o controle e exibição de um número maior de serpentes, acrescentando um maior fator lúdico. Em segundo lugar, realizar testes comparativos com diferentes métodos de filtragem do sinal do controle VR para avaliar vantagens e desvantagens de cada método. Por último, otimizar e melhorar o desempenho da aplicação, encontrando pontos de gargalos, de forma a possibilitar atingir um melhor desempenho em termos de \textit{fps}.
