...
As aplicações de realidade virtual são imersivas no sentido de reconstruir a visão de mundo de seu utilizador através do universo virtual, para tanto o conteúdo deve estar disponível em 360 graus. Tem-se então outro desafio: como transformar um jogo jogável sobre um plano em jogável sobre um ambiente virtual?

Há essencialmente duas abordagens: a icosfera, uma esfera sem polos, cujos vértices são distribuídos uniformemente; e a esfera baseada em longitude/latiture.
...
Para alcançar este efeito, utilizamos um \textit{mesh} de esfera gerado proceduralmente, definindo-se unicamente o raio.
