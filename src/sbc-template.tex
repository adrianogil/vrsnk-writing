...
A arquitetura proposta não é utilizada em larga escala, mas recentemente o jogo \textit{Jelly in the Sky} foi disponibilizado para aquisição na plataforma de jogos para computador \textit{Steam}. O desenvolvedor descreveu o trabalho gerado bem como desafios na rede online \textit{Reddit}.
