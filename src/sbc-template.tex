...
As aplicações de realidade virtual são imersivas no sentido de reconstruir a visão de mundo de seu utilizador através do universo virtual. Tem-se então o desafio de exibir conteúdo bidimensional em 360 graus. Há essencialmente duas abordagens: a icosfera, uma esfera sem polos, cujos vértices são distribuídos uniformemente; e a esfera baseada em longitude/latitude. Fizemos uso da segunda abordagem  devido à possível analogia dos seus vértices com coordenadas de UV, então geramos um \textit{mesh} de esfera proceduralmente, definindo-se unicamente o raio, segundo o pseudocódigo abaixo:
...
Para identificar as coordenadas de UV correspondentes tanto em duas dimensões quanto em realidade virtual, os cálculos abaixo se fazem necessários. 
...
Em \ref{equation1}, R é o tamanho angular dado um valor de N, que representa o total longitudinal. Em \ref{equation2}, I representa o ângulo latitudinal atual. Em \ref{equation3} e \ref{equation4}, X e Y são eixos no plano. Contudo, o raio D é variável ao longo da secção longitudinal, portanto precisa-se unicamente de metade da esfera para identificar a variação da distância ao longo da altura, conforme representam as equações abaixo em função da latitude.
