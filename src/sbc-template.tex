...
A aplicação apresentou taxa média de 43.96 \textit{qps} (quadros-por-segundo), com mínima de 16 \textit{qps} e máxima de 60 \textit{qps}. Conforme representado pela figura \ref{fig:VRPerformanceChart}, a aplicação não mantém estavéis 60 \textit{qps} e isto se deve principalmente ao \textit{garbage collector} e à ferramentas de depuração, conforme apontado pela ferramenta de performance da \textit{Unity}, o \textit{profiler}. 
%Falar sobre o filtro como potencializador de lentidão
