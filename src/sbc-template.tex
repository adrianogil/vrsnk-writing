...
% Resumo proposta
Neste trabalho, propomos o desenvolvimento de um jogo cujas representações gráficas sejam inteiramente fundamentadas em código de GPU ao passo que as restrições lógicas concentrem-se na CPU, de maneira a atuar nos diferentes estágios da pipeline gráfica acima apresentada. Em alusão à um clássico, o jogo Snake será recriado para os dispositivos de realidade virtual da Samsung em uma aplicação Unity, no entanto, diferencia-se do original à medida que o jogador posiciona o objeto coletável através do controlador tendo a finalidade de fazer a serpente persegui-lo. Neste aspecto, objetivando solucionar o primeiro desafio apresentado aplica-se o Filtro de Kalman durante a leitura do posicionamento do cursor deste \textit{joystick} a fim de melhorar o reconhecimento do sinal e atenuar a inconsistência apresentada. 
...
O jogo bidimensional Jelly in the Sky, recentemente disponibilizado para aquisição na plataforma de jogos para computador Steam, utiliza uma estrutura baseada em shader similar à arquitetura apresentada aqui. \cite{joselli_clua_2009} defendem um trabalho onde a GPU executa todo o processamento do jogo criado.
